...
@property (nonatomic, assign) id <XTabBarDelegate> delegate;    //default is nil.
...
@property (nonatomic) UIColor   *   separatorColor;         //default is white
@property (nonatomic) UIFont    *   textNormalFont;         //default is systemFontOfSize 14
@property (nonatomic) UIFont    *   textSelectedFont;       //default is systemFontOfSize 14
@property (nonatomic) UIColor   *   textNormalColor;        //default is black
@property (nonatomic) UIColor   *   textSelectedColor;      //default is blue
@property (nonatomic) UIColor   *   tabLineColor;           //default is blue
@property (nonatomic) UIImage   *   tabLineImage;           //default is nil
@property (nonatomic, assign)   CGFloat tabLineHeight;      //default is 1.5f
@property (nonatomic) UIColor   *   badgeBackgroundColor;   //default is red
@property (nonatomic) UIColor   *   badgeTextColor;         //default is white
